        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {opportunities.map((item) => (
              <button
                ...
                className="bg-cream p-8 rounded-[24px] text-left hover:shadow-lg hover:-translate-y-1 transition duration-300 border border-transparent hover:border-accent"
              >
                ...
                <span className="inline-block mt-6 text-brand font-semibold">
                  Learn More →
                </span>
              </button>
            ))}
          ...
          <div className="text-center mt-12">
            <button
              type="button"
              onClick={() => setIsPartnerOpen(true)}
              className="inline-flex bg-brand text-white px-8 py-4 rounded-xl font-semibold hover:bg-brand-dark transition"
            >
              Become A Sponsor
            </button>
          </div>
