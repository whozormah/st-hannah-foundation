      ...
      <section className="py-24 bg-cream">
        ...
        <div className="container-custom">
          ...
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="max-w-3xl mx-auto mt-6 text-lg text-gray-700 leading-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {programs.map((program) => (
              <Link
                ...
                key={program.slug}
                className="bg-white rounded-[32px] p-8 border border-gray-100 hover:border-accent/50 hover:shadow-xl hover:-translate-y-2 transition-all duration-300 block"
              >
            ...
            <div className="bg-brand text-white rounded-[32px] p-8 border border-brand hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
              <div className="w-16 h-1 bg-accent rounded-full mb-6" />
              ...
              <button
                ...
                className="mt-6 bg-white text-brand px-6 py-3 rounded-xl font-semibold hover:scale-105 transition"
              >
                Donate Items
              </button>
            </div>
