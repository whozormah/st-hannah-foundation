      ...
      <div className="container-custom">
        ...
        <div className="grid gap-8 lg:grid-cols-2 mb-16">
          ...
          <div className="group rounded-[36px] bg-white p-10 shadow-lg transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl">
            <div className="flex items-center gap-5">
              <div className="flex h-20 w-20 items-center justify-center rounded-3xl bg-[#FFF8EC] group-hover:bg-[#844204] transition">
                <MapPin
                  size={36}
              ...
              <div>
                <span className="uppercase tracking-[4px] text-sm text-[#844204] font-semibold">
                  Headquarters
                </span>
            ...
            <div className="mt-10 space-y-6">
              ...
              <div className="flex items-center gap-4">
                <Phone size={18} className="text-[#844204]" />
        ...
        <div className="grid gap-8 md:grid-cols-2 mb-16">
          <div className="rounded-[32px] bg-white p-8 shadow-lg">
            <div className="flex items-center gap-4">
              <Mail size={26} className="text-[#844204]" />
          ...
          <div className="rounded-[32px] bg-white p-8 shadow-lg">
            <div className="flex items-center gap-4">
              <Clock size={26} className="text-[#844204]" />
