      ...
      >
        ...
        <div className="sticky top-0 z-10 bg-white border-b px-8 py-6 flex items-start justify-between rounded-t-[32px]">
          <div>
            ...
            <h2 className="text-3xl font-bold text-[#1B1815] mt-2">
              Make Your Donation
            </h2>
            ...
            {programName && (
              <div className="mt-4 inline-flex items-center rounded-full bg-[#844204]/10 px-4 py-2 text-[#844204] font-medium">
