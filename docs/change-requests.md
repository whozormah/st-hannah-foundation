...
- **Change, words:** Esther's campaign story is retold, warm and short, as
  ...
  a safe place to live. Added at the Foundation's direction: she is raising
  her four children alone, and her menial work is not steady or always enough
  to feed them. Nothing is added about where she lives or the causes of her
  hardship.
...
| — | Go live | Launched 19 September 2026 on the DigitalOcean server behind Cloudflare; nameservers moved from Hostinger; email unchanged (Hostinger mailboxes, Resend) | 19 Sep 2026 | The Privacy Policy and Terms in effect from 18 September 2026 |
